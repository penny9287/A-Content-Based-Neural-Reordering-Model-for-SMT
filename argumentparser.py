...
def ArgumentParser():
    ...
    parser.add_argument('--data_dir', type=str, default='data',
                        help='data directory')
    parser.add_argument('--embedding_file_path', type=str, default='corpus.en.vec',
    ...
    parser.add_argument('--len_labels_index', type=int, default=4,
                        help='Number of label classes')
    parser.add_argument('--max_sequence_len', type=int, default=50,
